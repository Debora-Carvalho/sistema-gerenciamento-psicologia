...
//Acho que falta mais uma verificação se esta em andamento aparece, mas provevlemte a linha 50 do CardAgendametno ja faz esse trabalho, mas por alguma  razao nao filtra na minha tela, o erro sou eu
        if(agendamento.statusAgendamento =="Em andamento"){
