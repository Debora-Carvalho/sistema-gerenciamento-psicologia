...
function LoginCadastro() {
    ...
    const [mostrarConfirmaSenhaCadastro, setMostrarConfirmaSenhaCadastro] = useState(false);
                            ...
                            {!modoCadastro && (
                                ...
                                >
                                    <div className="conteudo-login-campos">
                                        ...
                                        <div className={`conteudo-cadastro-formulario ${mensagemErroLogin ? "formulario-erro" : ""}`}>
                                            <FaLock />
                                            <input
                                ...
                                >
                                    <div className="conteudo-cadastro">
                                        ...
                                        <div className={`conteudo-cadastro-formulario ${mensagemErroCadastro ? "formulario-erro" : ""}`}>
                                            <FaLock />
                                            <input
                                                type={mostrarConfirmaSenhaCadastro ? "text" : "password"}
                                            ...
                                            <button
                                                type="button"
                                                className="olho-logincadastro"
                                                onClick={() => setMostrarConfirmaSenhaCadastro(!mostrarConfirmaSenhaCadastro)}
                                            >
                                                {mostrarConfirmaSenhaCadastro ? "🙈" : "👁️"}
                                            </button>
                                        </div>
